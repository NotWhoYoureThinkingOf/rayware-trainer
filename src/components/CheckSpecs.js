    ...
    <div className={styles.checkSpecs}>
      ...
      <div className={styles.checkSpecs__systems}>
        ...
        <div ref={windowsMockup} className={styles.checkSpecs__windowsModal}>
          {macModal && (
            <div className={styles.checkSpecs__macModalContainer}>
              <div
                className={styles.checkSpecs__macModalClose}
          ...
          {windowsModal && (
            <div className={styles.checkSpecs__windowsModalContainer}>
              ...
              <div className={styles.checkSpecs__windowsSteps}>
                {step1 && (
                  <p>
                    Type "dxdiag" in search bar below. This will locate the
                    DirectX Diagnostic Tool. Click "dxdiag" to open it up.
                  </p>
                )}
                {step2 && (
                  <>
                    <p>
                      The DirectX Diagnostic Tool lists out the hardware you
                      have on your computer.
                    </p>
                    <p style={{ margin: "1rem 0" }}>
                      The System tab will list your Operating System, Processor,
                      and Memory. The Display 1 (and sometimes Display 2) tab
                      will list your Graphics Card under Name or Chip Type
                    </p>
                  ...
                  <div className={styles.checkSpecs__dxDiagBody}>
                    ...
                    {activeTab === "system" && (
                      <div className={styles.checkSpecs__dxDiagInfo}>
                        <p>
                          This tool reports detailed information about the
                          DirectX components and drivers installed on your
                          system.
                        </p>
                        <p>
                          If you know what area is causing the problem, click
                          the appropriate tab above. Otherwise, you can use the
                          "Next Page" button below to visit each page in
                          sequence.
                        </p>
                    ...
                    {activeTab === "display" && (
                      <div className={styles.checkSpecs__dxDisplayInfo}>
                        <div className={styles.checkSpecs__dxDisplayTop}>
                          <div className={styles.checkSpecs__dxDisplayDevice}>
                            <div className={styles.checkSpecs__dxDisplayLeft}>
                              <p className={styles.checkSpecs__dxDeviceTitle}>
                                {" "}
                                Device
                              </p>
                              <ul>
                          ...
                          <div className={styles.checkSpecs__dxDisplayDrivers}>
                            <p className={styles.checkSpecs__dxDriverTitle}>
                              Drivers
                            </p>
                            <p className={styles.checkSpecs__dxDriverInfo}>
                              Driver Information
                            </p>
                          </div>
                        </div>
                        ...
                        <div className={styles.checkSpecs__dxDisplayBottom}>
                          <p className={styles.checkSpecs__dxNotesTitle}>
                            Notes
                          </p>
                          <p className={styles.checkSpecs__dxNote}>
                            No problems found.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className={styles.checkSpecs__dxDiagButtons}>
                      <button className={styles.checkSpecs__dxSave}>
                        Save All Information...
                      </button>
                      <button
                        className={styles.checkSpecs__dxExit}
                        onClick={closeDxdiag}
                      >
                        Exit
                      </button>
